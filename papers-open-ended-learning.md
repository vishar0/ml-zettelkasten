...
- [2023] [[papers-generalist-agents]] Voyager: An Open-Ended Embodied Agent with Large Language Models - [paper](https://arxiv.org/abs/2305.16291), [website/code](https://voyager.minedojo.org/)

## Curriculum / Environment Design / Exploration

- [2017] [[papers-rl]] Intrinsic Motivation and Automatic Curricula via Asymmetric Self-Play - [paper](https://arxiv.org/abs/1703.05407)
- [2018] [[papers-rl]] Diversity is All You Need: Learning Skills without a Reward Function - [paper](https://arxiv.org/abs/1802.06070)
- [2018] [[papers-rl]] RND: Exploration by Random Network Distillation
- [2020] [[papers-rl]] PLR: Prioritized Level Replay - [paper](https://arxiv.org/abs/2010.03934)
- [2020] [[papers-rl]] Learning with AMIGo: Adversarially Motivated Intrinsic Goals - [paper](https://arxiv.org/abs/2006.12122)
...
- [2022] [[papers-generalist-agents]] Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos - [paper](https://arxiv.org/abs/2206.11795), [blog](https://openai.com/index/vpt/)
- [2023] [[papers-generalist-agents]] Describe, Explain, Plan and Select: Interactive Planning with Large Language Models Enables Open-World Multi-Task Agents - [paper](https://arxiv.org/abs/2302.01560), [code](https://github.com/CraftJarvis/MC-Planner)
