...
- **Approximate gradient (1-step gradient, no BPTT)**:
  ...
  - **One-liner**: same fixed-point / implicit-depth view as DEQ, but DEQ pays for the exact $(I-J)^{-1}$ while HRM takes the 1-step ($\approx I$) shortcut.
- **Deep supervision**:
