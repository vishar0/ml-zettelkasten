...
- **Related**:
  ...
  - [[aixi]] — Universal prediction and Solomonoff induction.
...
- [ ] [1998] A Formal Definition of Intelligence Based on an Intensional Variant of Algorithmic Complexity - [paper](https://www.researchgate.net/publication/2472570_A_Formal_Definition_of_Intelligence_Based_on_an_Intensional_Variant_of_Algorithmic_Complexity)
- [ ] [1999] [Mahoney] Text Compression as a Test for Artificial Intelligence - [paper](https://gwern.net/doc/cs/algorithm/information/compression/1999-mahoney.pdf)
...
- [ ] [2019] BB-ANS: Practical Lossless Compression with Latent Variables using Bits Back Coding - [paper](https://arxiv.org/abs/1901.04866). orig. Hinton & van Camp 1993; bridges VAE/diffusion ELBO → real compression; cf. [[papers-vae]] [[diffusion]]
